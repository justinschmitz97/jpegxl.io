...
export default function Syntax(props: { language: string; children: any }) {
  ...
  return (
    <div className="relative code group">
      ...
      <button
        className="absolute top-0 left-full z-50 py-2 px-1 w-8 text-blue-400 rounded-l-none rounded-r-md opacity-0 cursor-pointer group-hover:opacity-100 hover:text-white hover:bg-blue-400 copycode bg-bg-800 bg-blue-1000 group"
