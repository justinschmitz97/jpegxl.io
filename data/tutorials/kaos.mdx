...
With the release of version 2021.04 of KaOS's rolling release distribution, its package manager "kcp" has been further revised, JPEG XL images are supported, many software packages have been updated, and Plasma 5.21.30 is the default Desktop Environment.

The KDE Applications 21.04.0, which are known as KDE Gears, are also included. KDE Frameworks 5.81.0 and Qt 5.15.2 serve as the foundation. The KaOS team receives the patches published by the KDE project.
