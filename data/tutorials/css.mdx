...
Here is an SCSS background mixincan be used to support JXL, AVIF and WebP including Retina support.
...
Type declarations are a featureis unique to CSS4. 90% of browsers currently support image-set but do not yet support type declarations. In the absence of browser support for this feature, we must rely on JavaScript to detect the presence of JXL, AVIF, and WebP support.
