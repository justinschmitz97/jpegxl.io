...
<Quote
  text="The Apple ports use the system-provided image decoding capabilities; we're unlikely to deviate from that here, so any support for [..] depends on underlying OS support."
  author="Sam Sneddon"
