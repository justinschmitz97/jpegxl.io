...
description: Google introduced JPEG XL support for Chrome this week, but there are still some limitations. We show you how to use it.
keyword: Chrome
category: tutorials
subcategory: browser
...
<Checklist
  items={[
    ...
    "Type the following: chrome://flags/#enable-jxl",
    'The first and marked result shows an entry called "Enable JXL image format" with the description "Adds image decoding support for the JPEG XL image format. – Mac, Windows, Linux, Chrome OS, Android" and the hashtag "#enable-jxl".',
