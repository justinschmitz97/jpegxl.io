...
Don't worry if you don't see the JPEG XL image! This necessarily does not meansupport is unavailable, onlyit may not be enabled by default. If you want to allow support, make sure your browser is up-to-date and follow these guides:
