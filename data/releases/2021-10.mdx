...
It's here! Not like anyone has been waiting for it, but I'm super happy to announce that JPEGXL.io is live. Unfortunately, there is no progress tracking as in avif.io since libjxl doesn't provide an API for it, but that's fine since conversion doesn't take long! The converter, in general, is still in the beta phase but has many features for you to benefit from.
...
<Checklist
  items={[
    ...
    "Track Analytics for statistics and Hotjar for UX improvements",
...
Reach out for Feedback on the Discord channel or at my Twitter @juschmitz97.
