...
tags:
  - release notes
  - jpegxl converter changelog
questions:
  - What has changed on jpegxl.io in October 2021?
sources:
...
It's here! Not like anyone has been waiting for it, but I'm super happy to announceJPEGXL.io is live after all the hard work.
...
The converter offers you many things! There's a lot of settings you can choose from andlike on avif.io, it works completely client-sided.
...
We are starting closed source and will become open source after 6-9 months,like avif.io. You'll then have access to the full functionality, from blog posts to converters.
